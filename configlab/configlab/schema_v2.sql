-- ============================================================
-- configlab schema v2 — auth, devices, credentials, groups
...
VALUES
  ('ldap', FALSE, '{
    ...
    "bindDN": "cn=svc-configlab,ou=ServiceAccounts,dc=example,dc=com",
    ...
    "adminGroup": "CN=configlab-admins,ou=Groups,dc=example,dc=com"
  }'),
  ('saml', FALSE, '{
    "entryPoint": "https://idp.example.com/saml/sso",
    "issuer": "configlab",
    "callbackUrl": "https://configlab.yourdomain.com/auth/saml/callback",
    ...
    "attributeMapping": {
      ...
      "adminGroupValue": "configlab-admins"
    }
  }')
ON CONFLICT DO NOTHING;
